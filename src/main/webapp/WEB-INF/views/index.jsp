...
<body>
	...
	<h2>1. Meu projeto: Atendimento de extraclasse dos alunos do
		campus</h2>
	<h2>2. Gestão do almoxarifado do Campus</h2>
	<h2>3. Gestão de Atendimentos do setor saúde e pedagogia do Campus</h2>
	<h2>4. Gestão de emprestimo de chaves e equipamentos do SAE</h2>
	<h2>5. Gestão de funcionários de uma empresa (lotação, dados
		pessoais, dados contratuais, histórico de cargos, histórico de
		salários, dependentes, licenças/afastamentos, férias)</h2>
	<h2>6. Gestão de reservas de salas do Campus</h2>

	<p>
		<strong>Tarefa: Realizar a especificação de requisitos e
			fazer o modelo lógico do banco de dados (utilizando o mysql
			workbench) para entregar na proxima semana.</strong>
	</p>
